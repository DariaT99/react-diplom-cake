      ...
      <div className="header-main">
        <div className="header-main__wrapper wrapper">
          <div className="header-main__phone">
            <a href="tel:+7-961-346-75-89">+7 961 346 75 89</a>
            {/*<p>Ежедневно: с 09-00 до 21-00</p>*/}
          </div>
          <div className="header-main__logo">
            <Link to="/">
              <h1>
                <img src={header_logo} width={120} height={120} alt="logotype" />
              </h1>
            </Link>
            <p>Торты и другие сладкие десерты на Ваш праздник!</p>
          </div>
        ...
        <div className="header-main__hidden-panel hidden-panel">
          ...
          {loadedCartItems.length > 0 ?
            <div className="hidden-panel__basket basket-dropped">
              ...
              <div className="basket-dropped__title">В корзине пока ничего нет. Выберите что-нибудь сладкое в нашем меню</div>
            </div>}
        </div>
      </div>
    );
